...
window.onload = function () {
	...
	function loadAssets() {
		...
		var p1 = new Promise(function (resolve, reject) {
			...
			loader.add('model3', "assets/C97_Suzu/C97_Suzu.model3.json", xhrType);
			loader.add('motion1', "assets/C97_Suzu/motions/C97_Suzu1.motion3.json", xhrType);
			loader.add('motion2', "assets/C97_Suzu/motions/C97_Suzu1.motion3.json", xhrType);
